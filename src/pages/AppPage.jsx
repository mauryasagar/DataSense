              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-5 bg-transparent font-sans">
                ...
                {pdfSummaryLoading ? (
                  <div className="flex items-center gap-2.5 p-3.5 text-xs text-zinc-500 font-semibold bg-zinc-50/50 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/80 rounded-xl">
                    ...
                    <span>Synthesizing EDA metrics with local Qwen summary model...</span>
                  </div>
                ) : pdfSummary ? (
                  <div className="p-4 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-2">
                    <div className="flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800/50 pb-2 mb-1.5">
                      ...
                      <span className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Executive Summary</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between gap-4 p-3 rounded-xl bg-zinc-50/50 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/60">
                    <div className="flex items-center gap-2 text-xs font-semibold text-zinc-650 dark:text-zinc-400">
                      ...
                      <span>Generate an AI-powered plain English analysis of this dataset.</span>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/50 shadow-sm hover:shadow hover:border-zinc-300 dark:hover:border-zinc-700 transition-all group hover:-translate-y-0.5">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest block mb-1">Total Rows</span>
                    <p className="text-xl sm:text-2xl font-extrabold text-zinc-950 dark:text-zinc-50 mt-0.5 transition-colors">{parsedData.edaResult.overview.totalRows}</p>
                  </div>
                  <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/50 shadow-sm hover:shadow hover:border-zinc-300 dark:hover:border-zinc-700 transition-all group hover:-translate-y-0.5">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest block mb-1">Total Columns</span>
                    <p className="text-xl sm:text-2xl font-extrabold text-zinc-950 dark:text-zinc-50 mt-0.5 transition-colors">{parsedData.edaResult.overview.totalCols}</p>
                  </div>
                  <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/50 shadow-sm hover:shadow hover:border-zinc-300 dark:hover:border-zinc-700 transition-all group hover:-translate-y-0.5">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest block mb-1">Columns Types</span>
                    <p className="text-xs font-extrabold text-zinc-700 dark:text-zinc-300 mt-1.5 space-x-1.5">
                      <span className="bg-amber-50 text-amber-750 dark:bg-amber-950/20 dark:text-amber-400 border border-amber-100/50 dark:border-amber-900/30 px-1.5 py-0.5 rounded font-mono font-bold">Num:{parsedData.edaResult.overview.numericCount}</span>
                      <span className="bg-zinc-50 text-zinc-650 dark:bg-zinc-800 dark:text-zinc-450 border border-zinc-200/50 dark:border-zinc-700/50 px-1.5 py-0.5 rounded font-mono font-bold">Cat:{parsedData.edaResult.overview.categoricalCount}</span>
                    </p>
                  </div>
                  <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/70 dark:bg-zinc-900/50 shadow-sm hover:shadow hover:border-zinc-300 dark:hover:border-zinc-700 transition-all group hover:-translate-y-0.5">
                    <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest block mb-1">Missing Values</span>
                    <p className={`text-xl sm:text-2xl font-extrabold mt-0.5 transition-transform origin-left ${parsedData.edaResult.overview.totalMissing > 0 ? 'text-amber-500' : 'text-emerald-500'}`}>{parsedData.edaResult.overview.totalMissing}</p>
                  </div>
                </div>

                {/* Missing values and numerical analyses */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Missing analysis list */}
                  <div className="panel-card space-y-4">
                    <div>
                      <span className="section-label block mb-1">Data Health</span>
                      <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Missing Values Analysis</h3>
                    </div>
                    <div className="space-y-2 max-h-72 overflow-y-auto pr-1">
                      {Object.entries(parsedData.edaResult.missingAnalysis).map(([col, meta]) => (
                        <div key={col} className="group flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-white/70 dark:bg-zinc-900/70 border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-md hover:border-zinc-400 dark:hover:border-zinc-500 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/40 transition-all cursor-default">
                          <div>
                            <span className="text-[13px] sm:text-[14px] font-bold text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-950 dark:group-hover:text-white truncate block max-w-[160px]">{col}</span>
                            {meta.flag && (
                              <span className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-red-150 text-red-750 dark:bg-red-950/20 dark:text-red-400 mt-1 inline-block">High Missing (&gt;20%)</span>
                            )}
                          </div>
                          <div className="text-right text-xs font-mono font-bold text-zinc-500 dark:text-zinc-400">
                            {meta.count} missing ({meta.percentage.toFixed(1)}%)
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  {/* Numerical stats detail */}
                  <div className="panel-card space-y-4">
                    <div>
                      <span className="section-label block mb-1">Summary Metrics</span>
                      <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Numeric Columns Descriptive Stats</h3>
                    </div>
                    <div className="space-y-3.5 max-h-72 overflow-y-auto pr-1">
                      {Object.keys(parsedData.edaResult.numericStats).length === 0 ? (
                        <div className="text-zinc-400 text-xs italic">No numerical columns in this dataset.</div>
                      ) : (
                        Object.entries(parsedData.edaResult.numericStats).map(([col, stats]) => (
                          <div key={col} className="p-3.5 rounded-2xl border border-zinc-150 dark:border-zinc-800/80 bg-zinc-50/40 dark:bg-zinc-900/30 space-y-2">
                            <div className="flex justify-between items-center">
                              <span className="text-[13px] sm:text-[14px] font-bold text-zinc-800 dark:text-zinc-200 truncate max-w-[180px]">{col}</span>
                              <span className="text-[10px] sm:text-[11px] font-bold px-1.5 py-0.5 rounded bg-zinc-200 dark:bg-zinc-850 text-zinc-700 dark:text-zinc-300">{stats.outlierCount} outliers (IQR)</span>
                            </div>
                            <div className="grid grid-cols-3 gap-2 text-center text-xs font-mono">
                              <div className="p-1 rounded bg-white dark:bg-zinc-900 border border-zinc-150/50 dark:border-zinc-850">
                                <span className="text-[9px] sm:text-[10px] text-zinc-450 uppercase font-bold tracking-wider block">Mean</span>
                                <span className="font-bold text-[12px]">{stats.mean.toFixed(2)}</span>
                              </div>
                              <div className="p-1 rounded bg-white dark:bg-zinc-900 border border-zinc-150/50 dark:border-zinc-850">
                                <span className="text-[9px] sm:text-[10px] text-zinc-450 uppercase font-bold tracking-wider block">Median</span>
                                <span className="font-bold text-[12px]">{stats.median}</span>
                              </div>
                              <div className="p-1 rounded bg-white dark:bg-zinc-900 border border-zinc-150/50 dark:border-zinc-850">
                                <span className="text-[9px] sm:text-[10px] text-zinc-450 uppercase font-bold tracking-wider block">StdDev</span>
                                <span className="font-bold text-[12px]">{stats.stdDev.toFixed(2)}</span>
                              </div>
                            </div>
                          </div>
                        ))
                ...
                {/* Categorical top values frequency */}
                <div className="panel-card space-y-4">
                  <div>
                    <span className="section-label block mb-1">Frequency Analyses</span>
                    <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Categorical Column Distributions</h3>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[350px] overflow-y-auto pr-1">
                    {Object.keys(parsedData.edaResult.categoricalStats).length === 0 ? (
                      <div className="text-zinc-400 text-xs italic">No categorical columns identified.</div>
                    ) : (
                      Object.entries(parsedData.edaResult.categoricalStats).map(([col, stats]) => (
                        <div key={col} className="p-3.5 rounded-2xl border border-zinc-150 dark:border-zinc-850 bg-zinc-50/30 dark:bg-zinc-900/20 space-y-2.5">
                          <div className="flex justify-between items-center text-[13px] sm:text-[14px] font-bold text-zinc-800 dark:text-zinc-300">
                            <span className="truncate max-w-[180px]">{col}</span>
                            <span className="text-[10px] sm:text-[11px] font-bold text-zinc-550 dark:text-zinc-450">{stats.uniqueCount} uniques</span>
                          </div>
                          <div className="space-y-1.5 text-xs">
                            {stats.topValues.map((v, idx) => (
                              <div key={idx} className="space-y-1">
                                <div className="flex justify-between font-semibold">
                                  <span className="text-[13px] text-zinc-700 dark:text-zinc-300 truncate max-w-[180px]">{v.value || 'null'}</span>
                                  <span className="text-zinc-500 font-mono text-[11px] sm:text-[12px]">{v.count} occurrences</span>
                                </div>
                                <div className="w-full bg-zinc-200 dark:bg-zinc-800 h-1.5 rounded-full overflow-hidden">
                                  <div className="bg-zinc-900 dark:bg-white h-full transition-all" style={{ width: `${(v.count / parsedData.rows.length) * 100}%` }} />
                                </div>
                              </div>
                            ))}
                          </div>
                ...
                <div className="panel-card space-y-4">
                  <div>
                    <span className="section-label block mb-1">Feature Relationships</span>
                    <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Correlation Matrix (Pearson r)</h3>
                  </div>
                  {Object.keys(parsedData.edaResult.correlationMatrix).length === 0 ? (
                    <div className="text-zinc-400 text-xs italic">Requires at least two numerical columns to compute correlations.</div>
                  ) : (
                    <div className="overflow-x-auto">
                      <div className="min-w-max p-1">
                        <table className="divide-y divide-zinc-200 dark:divide-zinc-800 text-xs font-mono text-center">
                          <thead>
                            <tr>
                              <th className="px-3 py-2 text-left font-sans font-bold text-[11px] sm:text-xs text-zinc-500 border-b border-zinc-200 dark:border-zinc-800">Column</th>
                              {Object.keys(parsedData.edaResult.correlationMatrix).map(col => (
                                <th key={col} className="px-3 py-2 font-bold text-[11px] sm:text-xs text-zinc-500 border-b border-zinc-200 dark:border-zinc-800 rotate-45 select-none" style={{ maxWidth: 80 }}>
                          ...
                          <tbody>
                            {Object.entries(parsedData.edaResult.correlationMatrix).map(([rowCol, targets]) => (
                              <tr key={rowCol} className="border-b last:border-0 border-zinc-100 dark:border-zinc-900">
                                <td className="px-3 py-2 text-left font-sans font-bold text-[11px] sm:text-xs text-zinc-700 dark:text-zinc-300 max-w-[120px] truncate">{rowCol}</td>
                                {Object.keys(parsedData.edaResult.correlationMatrix).map(col => {
                                  const r = targets[col];
                                  // Assign color style based on strength
                                  const isStrongPos = r > 0.6;
                                  const isStrongNeg = r < -0.6;
                                  const style = isStrongPos 
                                    ? 'bg-emerald-100/50 text-emerald-800 dark:bg-emerald-950/20 dark:text-emerald-300' 
                                    : isStrongNeg 
                                    ? 'bg-amber-100/50 text-amber-800 dark:bg-amber-950/20 dark:text-amber-300' 
                                    : 'text-zinc-400';
                                  return (
                                    <td key={col} className={`px-4 py-2 font-extrabold text-[12px] sm:text-[13px] ${style}`} title={`Correlation: ${r.toFixed(4)}`}>
                                      {r.toFixed(2)}
                                    </td>
                                  )
                                })}
